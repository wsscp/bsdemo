...
import cc.oit.bsmes.job.tasks.ShortScheduleTask;
import org.apache.commons.lang3.math.NumberUtils;
import org.quartz.*;
import org.springframework.stereotype.Service;

@Service
public class ShortScheduleJob extends BaseJob implements StatefulJob, InterruptableJob {

    private ShortScheduleTask shortScheduleTask;

    public void interrupt() throws UnableToInterruptJobException {
        logger.info("interrupt job...");
        shortScheduleTask.setInterrupt(true);
    }
    ...
    protected void executeInternal(JobExecutionContext context)
        ...
        try {
            ...
            shortScheduleTask = (ShortScheduleTask) ContextUtils.getBean(ShortScheduleTask.class);
            shortScheduleTask.setInterrupt(false);
            ...
            //执行业务操作
            shortScheduleTask.process(parm);
