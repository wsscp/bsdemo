...
import cc.oit.bsmes.job.tasks.MaintainScheduleTask;
import org.apache.commons.lang3.math.NumberUtils;
import org.quartz.*;
import org.springframework.stereotype.Service;

@Service
public class MaintainScheduleJob extends BaseJob implements StatefulJob, InterruptableJob {

    private MaintainScheduleTask maintainScheduleTask;

    public void interrupt() throws UnableToInterruptJobException {
        logger.info("interrupt job...");
        maintainScheduleTask.setInterrupt(true);
    }
    ...
    protected void executeInternal(JobExecutionContext context)
        ...
        try {
            ...
            maintainScheduleTask = (MaintainScheduleTask) ContextUtils.getBean(MaintainScheduleTask.class);
            maintainScheduleTask.setInterrupt(false);
            ...
            //执行业务操作
            maintainScheduleTask.process(parm);
