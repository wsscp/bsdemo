...
@Service
public class PlanScheduleJob extends BaseJob implements StatefulJob, InterruptableJob {

    private PlanScheduleTask planScheduleTask;

    public void interrupt() throws UnableToInterruptJobException {
        logger.info("interrupt job...");
        planScheduleTask.setInterrupt(true);
    }
    ...
    protected void executeInternal(JobExecutionContext context)
        ...
        try {
            ...
            planScheduleTask = (PlanScheduleTask) ContextUtils.getBean(PlanScheduleTask.class);
            planScheduleTask.setInterrupt(false);
