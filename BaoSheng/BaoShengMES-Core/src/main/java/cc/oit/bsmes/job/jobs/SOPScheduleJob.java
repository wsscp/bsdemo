...
import cc.oit.bsmes.job.tasks.SOPScheduleTask;
import org.apache.commons.lang3.math.NumberUtils;
import org.quartz.*;
import org.springframework.stereotype.Service;

@Service
public class SOPScheduleJob extends BaseJob implements StatefulJob, InterruptableJob {


    private SOPScheduleTask sopScheduleTask;

    public void interrupt() throws UnableToInterruptJobException {
        logger.info("interrupt job...");
        sopScheduleTask.setInterrupt(true);
    }
    ...
    protected void executeInternal(JobExecutionContext context)
        ...
        try {
            ...
            sopScheduleTask = (SOPScheduleTask) ContextUtils.getBean(SOPScheduleTask.class);
            sopScheduleTask.setInterrupt(false);
