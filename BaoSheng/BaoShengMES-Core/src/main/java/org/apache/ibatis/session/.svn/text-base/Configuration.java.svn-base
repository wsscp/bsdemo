...
public class Configuration {
  ...
  protected final Map<String, MappedStatement> mappedStatements = new FirstStrictMap<MappedStatement>("Mapped Statements collection");// chanedi!只保留真正的xml中的MappedStatements
