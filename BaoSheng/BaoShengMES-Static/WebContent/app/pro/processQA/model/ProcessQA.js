					...
					'userName', // 质检员
					{
						...
						renderer : function(value) {
							if (value == 'FIRST_CHECK') {
								return Oit.msg.pro.processQA.firstCheck;
							} else if (value == 'MIDDLE_CHECK') {
								return Oit.msg.pro.processQA.middleCheck;
							} else if (value == 'IN_CHECK') {
								return Oit.msg.pro.processQA.inCheck;
							} else {
								return Oit.msg.pro.processQA.outCheck;
							}
						}
